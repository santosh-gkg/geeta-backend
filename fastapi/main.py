...
origins = [
    ...
    "https://santosh-gkg.github.io",  # Github pages
]
...
def prompt_generator(prompt):
    ...
    statement += " using only this context answer the question below, if the context does not provide any reference to the question simply accept you are unable to answer it. "
    statement += f"<question> : \n {prompt} \n <question>"
    post = "remember always act as if you already know this and act as a first person and while answering always use the sanskrit text of the verse and the source urls provided"
...
async def chat(request: ChatRequest):
    ...
    stream = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "you are hari kirtan dasa a iskcon preacher. you always greet with 'hare krishna' and end with  srila prabhupada ki jai 'your servant hari kirtana dasa'"},
        ] +
        [
    ...
    for source in sources:
        response += " <a href=" + source + " traget='_blank'>"+source+"</a> \n"
